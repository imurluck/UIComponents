...
class ContextMenuDialogActivity : AppCompatActivity() {
    ...
    private fun setupContextMenuDialog() {
        contextMenuDialog = ContextMenuDialog.newInstance().apply {
            ...
            add(R.drawable.ic_close_primary_48dp)
            add("Send message", R.drawable.ic_message_primary_48dp)
            add("Add to favorites", R.drawable.ic_favorite_primary_48dp)
            add("Add to friends", R.drawable.ic_person_add_primary_48dp)
            add("Block user", R.drawable.ic_block_primary_48dp)
